...
- Restore PostgreSQL-backed Symfony sessions for `sc-187732` by wiring Doctrine DBAL/ORM, a PDO session handler, bootstrap/cleanup console commands, local Compose PostgreSQL, and callback regression coverage while documenting the remaining cluster follow-up for 3-replica rollout.
