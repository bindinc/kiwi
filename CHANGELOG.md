...
### Fixed
- Add payment instruction as a new-subscription payment method, preserve the selected Webabo payment code in the subscription queue, and run CI and release builds on GitHub-hosted runners.
