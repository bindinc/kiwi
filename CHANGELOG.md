...
### Fixed
- Add payment instruction as a new-subscription payment method, preserve the selected Webabo payment code in the subscription queue, run CI and release builds on GitHub-hosted runners, and use Symfony 8-compatible route attributes.
