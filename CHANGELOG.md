...
### Changed
- Update `plan/app-js-to-slices-checklist.md` domain status checkboxes to reflect current merge/implementation state (Items 1-13 complete, with only the Item 13 bridge-removal subtask still open), and refresh related status notes.
