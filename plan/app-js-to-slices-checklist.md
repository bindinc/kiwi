...
| 19 | Remove legacy facade wrappers that only proxy to slice methods | `codex/remove-legacy-facade-wrappers-proxying-to-slices` | - | `in progress` | `no` | Migrate remaining global function callers to router/slice entry points. |
