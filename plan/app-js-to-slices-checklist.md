...
| 20 | Remove app-shell fallback paths + move runtime wiring out of app.js | `codex/remove-app-shell-fallbacks-and-runtime-wiring-from-app-js` | - | `open` | `no` | App shell and runtime wiring should live in slice/runtime modules only. |
