...
| 3 | Werfsleutel catalog + picker implementation | `codex/implement-werfsleutel-catalog-and-picker-slice` | [#45](https://github.com/bindinc/kiwi/pull/45) | `in progress` | `no` |  |
