...
| 17 | Extract call-session start/duration UI bridge from app.js | `codex/extract-call-session-start-and-duration-ui-bridge` | - | `in progress` | `no` | Consolidate call-session timer/UI ownership. |
