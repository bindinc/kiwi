...
final class SubscriptionQueueService
{
    ...
    private function normalizeNewPersonPayload(array $payload): array
    {
        ...
        $normalized = [
            ...
            'houseNumberAddition' => $this->normalizeNullableString($payload['houseNumberAddition'] ?? null) ?? '',
            'countryCode' => 'NL',
    ...
    private function buildPersonSnapshot(array $person, array $context = []): array
    {
        ...
        $snapshot = [
            ...
            'postalCode' => $postalCode,
            'houseNumber' => $houseNumber,
            'houseNumberAddition' => $this->normalizeNullableString($person['houseNumberAddition'] ?? null) ?? '',
            'countryCode' => 'NL',
