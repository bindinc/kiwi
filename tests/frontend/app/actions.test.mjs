...
import { coerceActionValue, createActionRouter, extractActionPayload } from '../../../assets/js/app/actions.js';
import { registerCallQueueAgentStatusSlices } from '../../../assets/js/app/slices/index.js';
import { configureContactHistorySliceDependencies, registerContactHistorySlice } from '../../../assets/js/app/slices/contact-history-slice.js';
import { configureCustomerDetailSliceDependencies, registerCustomerDetailSlice } from '../../../assets/js/app/slices/customer-detail-slice.js';
import { registerLocalizationSlice } from '../../../assets/js/app/slices/localization-slice.js';
...
async function testCustomerDetailSliceLoadsSubscriptionApiDetailWithCredentialContext() {
    const listeners = {};
    const root = {
        addEventListener(eventType, handler) {
            listeners[eventType] = handler;
    ...
    try {
        ...
        assert.equal(
            requestedUrl,
            '/api/v1/persons/71234?credentialKey=tvk&sourceSystem=subscription-api'
        );
        assert.equal(currentCustomer.id, 71234);
...
async function run() {
    ...
    await testCustomerDetailSliceLoadsSubscriptionApiDetailWithCredentialContext();
